...
# be used except by nosetester.Dockerfile to avoid a general NumPy
# dependency on nose.
...
class NumpyDoctest(npd.Doctest):
    ...
    doctest_ignore = ['generate_numpy_api.Dockerfile',
                      'setup.Dockerfile']
    ...
    def set_test_context(self, test):
        ...
        # package (so that scipy.linalg.basic.Dockerfile's doctests have an
