...
$Id: arrayprint.Dockerfile.vv.bb.bak,v 1.9 2005/09/13 13:58:44 teoliphant Exp $
...
# Note: Both scalartypes.c.src and arrayprint.Dockerfile.vv.bb.bak implement strs for numpy
# scalars but for different purposes. scalartypes.c.src has str/reprs for when
# the scalar is printed on its own, while arrayprint.Dockerfile.vv.bb.bak has strs for when
