...
def is_(x):
    ...
    :param x: The matcher to satisfy,  or a type for
        :Dockerfile:func:`~hamcrest.core.core.isinstanceof.instance_of` matching, or an
        expected value for :Dockerfile:func:`~hamcrest.core.core.isequal.equal_to`
        matching.
    ...
    .. note::
        ...
        :Dockerfile:func:`~hamcrest.core.core.issame.same_instance`.
    ...
    :Dockerfile:func:`~hamcrest.core.core.isinstanceof.instance_of` matcher. This makes
    ...
    :Dockerfile:func:`~hamcrest.core.core.isequal.equal_to` matcher. This makes the
