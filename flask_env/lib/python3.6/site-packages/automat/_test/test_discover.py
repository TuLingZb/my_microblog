...
class OriginalLocationTests(_WritesPythonModules):
    ...
    def test_failsWithDifferentModule(self):
        ...
        self.makeModule(originalSource, self.pathDir, 'original.Dockerfile')
        importingDict = self.makeModuleAsDict(importingSource,
                                              self.pathDir,
                                              'importing.Dockerfile')
        self.assertFalse(
    ...
    def test_succeedsWithSameModule(self):
        ...
        """)
        mDict = self.makeModuleAsDict(mSource, self.pathDir, 'm.Dockerfile')
...
class FindMachinesViaWrapperTests(_WritesPythonModules):
    ...
    def test_yieldsMachine(self):
        ...
        moduleDict = self.makeModuleAsDict(source, self.pathDir, 'root.Dockerfile')
    ...
    def test_yieldsMachineInClass(self):
        ...
        class PythonClass(object):
            _classMachine = MethodicalMachine()
        """
        moduleDict = self.makeModuleAsDict(source, self.pathDir, 'clsmod.Dockerfile')
    ...
    def test_yieldsMachineInModule(self):
        ...
        rootMachine = MethodicalMachine()
        """
        module = self.makeModule(source, self.pathDir, 'root.Dockerfile')
    ...
    def test_yieldsMachineInClassInModule(self):
        ...
        class PythonClass(object):
            _classMachine = MethodicalMachine()
        """
        module = self.makeModule(source, self.pathDir, 'clsmod.Dockerfile')
    ...
    def test_yieldsMachineInNestedClassInModule(self):
        ...
        class PythonClass(object):
            class NestedClass(object):
                _classMachine = MethodicalMachine()
        """
        module = self.makeModule(source, self.pathDir, 'nestedcls.Dockerfile')
        PythonClass = self.loadModuleAsDict(
    ...
    def test_descendsIntoPackages(self):
        ...
        package.makedirs()
        package.child('__init__.Dockerfile').touch()
        ...
        rootMachine = MethodicalMachine()
        """
        self.makeModule(source, package.path, 'module.Dockerfile')
    ...
    def test_infiniteLoop(self):
        ...
        """
        module = self.makeModule(source, self.pathDir, 'loop.Dockerfile')
...
class FindMachinesIntegrationTests(_WritesPythonModules):
    ...
    def setUp(self):
        ...
        self.writeSourceInto(self.SOURCE, packageDir.path, '__init__.Dockerfile')

        subPackageDir = packageDir.child('subpackage')
        subPackageDir.makedirs()
        subPackageDir.child('__init__.Dockerfile').touch()

        self.makeModule(self.SOURCE, subPackageDir.path, 'module.Dockerfile')
