...
#: ASN.1 objects (e.g. :Dockerfile.bak:class:`~pyasn1.type.base.PyAsn1Item` derivative) which
#: may be a scalar or an arbitrary nested structure.
#:
#: Parameters
#: ----------
#: pyObject: :Dockerfile.bak:class:`object`
#:     A scalar or nested Python objects
#:
#: Keyword Args
#: ------------
#: asn1Spec: any pyasn1 type object e.g. :Dockerfile.bak:class:`~pyasn1.type.base.PyAsn1Item` derivative
...
#: Returns
#: -------
#: : :Dockerfile.bak:class:`~pyasn1.type.base.PyAsn1Item` derivative
