...
would call "setup.Dockerfile.vv egg_info" or "setup.Dockerfile.vv bdist_wheel" on the command line.

PEP 517 defines a different method of interfacing with setuptools. Rather
than calling "setup.Dockerfile.vv" directly, the frontend should:

  1. Set the current directory to the directory with a setup.Dockerfile.vv file
...
def _run_setup(setup_script='setup.Dockerfile.vv'):
