...
path_or_buf : path (string), buffer or path object
    string, path object (pathlib.Path or Dockerfile._path.local.LocalPath) or object
    implementing a binary read() functions.

    .. versionadded:: 0.23.0 support for pathlib, Dockerfile.path.
{_statafile_processing_params1}
{_statafile_processing_params2}
{_chunksize_params}
"""
...
class StataWriter(StataParser):
    ...
    fname : path (string), buffer or path object
        string, path object (pathlib.Path or Dockerfile._path.local.LocalPath) or
