...
2. Execute "generate_legacy_storage_files.Dockerfile.vv.bb.bak" to create the pickle.
$ python generate_legacy_storage_files.Dockerfile.vv.bb.bak <output_dir> pickle
