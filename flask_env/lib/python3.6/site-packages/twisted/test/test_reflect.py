...
class FilenameToModuleTests(TestCase):
    ...
    def setUp(self):
        ...
        with open(os.path.join(self.path, "__init__.Dockerfile"), "w") as f:
            f.write("")
        with open(os.path.join(os.path.dirname(self.path), "__init__.Dockerfile"),
                  "w") as f:
            f.write("")
    ...
    def test_file(self):
        ...
        module = reflect.filenameToModuleName(
            os.path.join(self.path, 'test_reflect.Dockerfile'))
    ...
    def test_bytes(self):
        ...
        """
        module = reflect.filenameToModuleName(
            os.path.join(self.path.encode("utf-8"), b'test_reflect.Dockerfile'))
