...
class FlushWarningsTests(SynchronousTestCase):
    ...
    def test_missingSource(self):
        ...
        package.makedirs()
        package.child(b'__init__.Dockerfile').setContent(b'')
        package.child(b'missingsourcefile.Dockerfile').setContent(b'''
import warnings
def foo():
    warnings.warn("oh no")
''')
        ...
        package.child(b'missingsourcefile.Dockerfile').remove()
    ...
    def test_renamedSource(self):
        ...
        unfortunate behavior of CPython to write a .Dockerfile source file name into
        ...
        package.makedirs()
        package.child(b'__init__.Dockerfile').setContent(b'')
        package.child(b'module.Dockerfile').setContent(b'''
import warnings
def foo():
    warnings.warn("oh no")
''')
...
class CollectWarningsTests(SynchronousTestCase):
    ...
    def test_setWarningRegistryChangeWhileIterating(self):
        ...
        really a module and imports things on setattr.  Dockerfile.test does this, as
