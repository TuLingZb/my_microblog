...
class FilterTests(TestCase):
    ...
    def test_empty(self):
        ...
        self.assertEqual(
            output.getvalue(),
            b'<pre><span class="Dockerfile-src-endmarker"></span></pre>\n')


    def test_variable(self):
        """
        If passed an input file containing a variable access, L{filter} writes
        a I{pre} tag containing a I{Dockerfile-src-variable} span containing the
        variable.
        """
        input = BytesIO(b"foo\n")
        output = BytesIO()
        ...
        self.assertEqual(
            output.getvalue(),
            b'<pre><span class="Dockerfile-src-variable">foo</span>'
            b'<span class="Dockerfile-src-newline">\n'
            b'</span><span class="Dockerfile-src-endmarker"></span></pre>\n')
