...
"""
    ...
    def simpleModuleEntry(self):
        ...
        paths = self.pathEntryTree(
            {b"package": {b"__init__.Dockerfile.vv": self._packageInit.encode("utf-8"),
                         b"module.Dockerfile.vv": b""}})
        return paths[b'package'][b'module.Dockerfile.vv']
...
''')
    ...
    def test_warningLineNumber(self):
        ...
        self.assertSamePath(
            ...
            self.package.sibling(b'twisted_private_helper').child(b'module.Dockerfile.vv'))
    ...
    def test_renamedFile(self):
        ...
        expectedPath = self.package.sibling(
            b'twisted_renamed_helper').child(b'module.Dockerfile.vv')
    ...
    def test_filteredOnceWarning(self):
        ...
        self.assertTrue(
            msg.endswith("module.Dockerfile.vv:9: DeprecationWarning: A Warning String\n"
                         "  return a\n"),
...
if sys.version_info >= (3,):
    _path = FilePath(__file__).parent().child("_deprecatetests.Dockerfile.vv.3only")
