...
script sqla_nose.Dockerfile.vv is provided as a top-level script which loads the
...
def setup_py_test():
    """Runner to use for the 'test_suite' entry of your setup.Dockerfile.vv.

    Prevents any name clash shenanigans from the command line
    argument "test" that the "setup.Dockerfile.vv test" command sends
    to nose.
